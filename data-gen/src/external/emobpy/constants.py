...
WEATHER_FILES = {
    "ERA5-hourly-dew_point_temp.csv": "hourly-dew_point_temp_Kelvin.csv",
    "ERA5-hourly-mslp.csv": "hourly-sea_level_pressure_Pascal.csv",
    "ERA5-hourly-t2m.csv": "hourly-temp_Kelvin.csv",
}

WEATHER_OPTIONS = {
    "dew_point Kelvin": "hourly-dew_point_temp_Kelvin.csv",
...
LAYER_CONDUCTIVITY = {
    ...
    "polyester+fiberglass": 0.64,
    "fiberglass": 2,
}  # W/(mK) ref: 10.1016/j.applthermaleng.2014.07.044
LAYER_THICKNESS = {
    "metal": 0.0009,
    "glassLaminated": 0.0045,
    "glassTempered": 0.0035,
    "polyurethane foam": 0.058,
    "polyester+fiberglass": 0.002,
    "fiberglass": 0.001,
}  # meter
...
WEEKS = {
    0: {"day": "Sunday", "week": "weekend", "day_code": "sunday"},
