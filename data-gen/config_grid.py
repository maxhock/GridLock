...
# Load .env file for environment-specific settings (this needs to be replaced with grid database credentials)
...
class Config:
    ...
    # --------------------------------------------------------------#
    # Important paths
    STORAGE_DIR = "data/grids"  # Directory in which to store results
