...
If you want a recorder in tree mode, it needs the same treatment as any other new class — see [`../template/README.md`](../template/README.md) — plus a real command and pinned dependencies.
Its `requirements` are currently just an unpinned `helics[cli]` install in the `Dockerfile`.
